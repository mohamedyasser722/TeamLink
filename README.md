...
curl -X DELETE http://localhost:3000/api/seeder/clear
```
...
**Database Management:**
- **Seed**: Clears existing data and populates with fresh demo data
- **Clear**: Removes all data from all entities (useful for testing)
- **Stats**: Shows current record counts in all tables
...
| `/api/seeder/clear` | DELETE | Clear all data from database |
